...
**Intro :** My undergraduate experience gave me a good understanding of the software development lifecycle and an appreciation for beautifully written code. Working in the financial industry for Citi I further developed these skills and realized my ability to build and scale enterprise applications. I then moved to Northern Labs, as an opportunity to work for a smaller company with less bureacracy and spend more time building and learning from talented senior engineers.

Working with large quantities of data at both Citi and my current Northern Labs, I most enjoyed the time I spent performing adhoc analysis of the data I was using to build applications on top of. Spending extra hours chatting with the quantitative engineers about potential uses of data, I realized my real passion was in Data Science, and the application development was more of a distraction. With that in mind - as well as a growing distaste for the financial field and a burning desire to move to the West Coast - I pursued a masters in data science at UBC, in order to develop my data analysis skills and apply them to a field I'm more passionate about. My current passion is public health - I believe healthcare should be affordable and accessible to all and am excited to work for companies that are aligned with that goal.
...
![](../img/mountain.jpg){fig-align="center" class="whoami-page-image"}
